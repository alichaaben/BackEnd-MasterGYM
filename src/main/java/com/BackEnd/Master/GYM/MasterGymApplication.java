...
public class MasterGymApplication {
	...
	public CommandLineRunner initDatabase() {
		return args -> {
			...
			Optional<Roles> adminRoleOpt = rolesRepo.findByRoleName("Admin");
			...
			Optional<Roles> coatchRoleOpt = rolesRepo.findByRoleName("Coatch");
			coatchRoleOpt.orElseGet(() -> {
				Roles newcoatchRole = new Roles();
				newcoatchRole.setRoleName("Coatch");
			...
			if (existingAdmin == null) {
				...
				adminUser.setMotDePasse("ali1234");
